        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6">
          <div className="text-center max-w-md w-full">
            ...
            <div className="relative inline-block">
              <div className="absolute top-[4px] left-[4px] sm:top-[6px] sm:left-[6px] w-full h-full bg-black rounded-lg sm:rounded-xl"></div>
              <button 
                onClick={() => navigate("/shop")}
                className="relative bg-[#d4ff00] hover:translate-y-[4px] hover:translate-x-[4px] sm:hover:translate-y-[6px] sm:hover:translate-x-[6px] text-black font-bold text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl border-2 font-mono border-black transition-transform duration-200 ease-in-out w-full sm:w-auto"
              >
                Continue Shopping
              </button>
            </div>
      ...
      {Math.round(((item.originalPrice - item.price) / item.originalPrice) * 100)}% OFF
                          ...
                          <div className="relative w-full sm:w-fit">
                            ...
                            <button
                              ...
                              className="relative bg-red-500 w-full hover:translate-y-[4px] hover:translate-x-[4px] sm:hover:translate-y-[6px] sm:hover:translate-x-[6px] text-white font-bold text-sm sm:text-base px-3 sm:px-4 py-2 rounded-lg border-2 font-mono border-black transition-transform duration-200 ease-in-out flex items-center justify-center sm:justify-start gap-2"
                            >
                              REMOVE
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="relative w-full">
                    <button
                      ...
                      className="relative bg-[#ff3f6c] hover:bg-[#e63a62] w-full text-white font-bold text-base sm:text-lg px-4 py-3 rounded-lg sm:rounded-xl border-2 font-mono border-black transition-transform duration-200 ease-in-out flex items-center justify-center gap-2 sm:gap-4"
                    >
                  ...
                  <div className="relative w-full">
                    ...
                    <button
                      onClick={() => navigate("/")}
                      className="relative bg-white w-full hover:translate-y-[4px] hover:translate-x-[4px] sm:hover:translate-y-[6px] sm:hover:translate-x-[6px] text-black font-bold text-base sm:text-lg px-4 py-3 rounded-lg sm:rounded-xl border-2 font-mono border-black transition-transform duration-200 ease-in-out flex items-center justify-center gap-2 sm:gap-4"
                    >
                      Continue Shopping
                    </button>
                  </div>
