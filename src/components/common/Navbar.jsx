...
import { logout, toggleModal } from "../../global_redux/features/auth/authSlice";
    ...
    <nav className="sticky top-0 z-50 border-b border-gray-100 bg-white/95 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-3 px-4 py-3.5">
        ...
        <div className="flex items-center gap-8">
          <Link to="/">
            <h1 className="cursor-pointer text-3xl font-black tracking-tight text-primary xl:text-4xl">
              UN
              <span className="text-[0.85em] font-medium not-italic text-primary/80">
                BOX
              </span>
            </h1>
          </Link>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      size={14}
                      className={`opacity-50 transition-transform duration-300 ${hoveredCategory === categoryId ? "rotate-180" : ""}`}
                    />
                  </Link>
        ...
        <div className="flex items-center gap-2 text-gray-700 sm:gap-3">
          ...
          <Link
            to="/wishlist"
            className="relative hidden h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white transition-colors hover:border-primary/30 hover:text-primary sm:flex"
          >
            <Heart size={18} />
            {wishlistCount > 0 && (
